...
import { EventActionAllungata, VistaMese } from './reminder.model';
...
export class ReminderComponent implements OnInit
{
    ...
    setEvents(): void
    {
        ...
        this.apiService.ritornaEventiReminder(params)
    ...
    deleteEvent(event): void
    {
        ...
        this.confirmDialogRef.afterClosed().subscribe(result => {
            if ( result )
            {
                ...
                this.apiService.eliminaEventoReminder(this.variabiliGlobali.CodAnnoSquadra, event.id)
                ...
                .subscribe(response => {
                    ...
                    switch ( actionType )
                    {
                        ...
                        case 'save':
                            ...
                            this.apiService.modificaEventoReminder(this.variabiliGlobali.CodAnnoSquadra, this.events[eventIndex], fs, fe)
                            .map(response2 => response2.text())
                            .subscribe(
                                data => {
                                if (data) {
        ...
        this.dialogRef.afterClosed()
            .subscribe((response: FormGroup) => {
                ...
                if (newEvent.tipologiaEvento === 1) {
                    ...
                    this.apiService.salvaEventoReminder(this.variabiliGlobali.CodAnnoSquadra, newEvent)
                    .map(response2 => response2.text())
                    .subscribe(
                        data => {
                        if (data) {
    ...
    chiusuraMaschera(e) {
        ...
        switch (this.ultimaAzione) {
            case 'ADD':
                this.apiService.salvaEventoReminder(this.variabiliGlobali.CodAnnoSquadra, this.appoEvent)
                .map(response2 => response2.text())
                .subscribe(
                    data => {
                    if (data) {
                        ...
                        if (data2.indexOf('ERROR') === -1) {
                            ...
                            this.setEvents();
                            this.variabiliGlobali.mostraMessaggio('Nuova partita creata', false);
                        } else {
                            // console.log(data2);
                        }
                    }
                ...
                break;
            case 'EDIT':
                this.apiService.modificaEventoReminder(this.variabiliGlobali.CodAnnoSquadra, this.appoEvent, fs, fs)
                .map(response2 => response2.text())
                .subscribe(
                    data => {
                    if (data) {
                        ...
                        if (data2.indexOf('ERROR') === -1) {
                            ...
                            this.setEvents();
                            this.variabiliGlobali.mostraMessaggio('Partita modificata', false);
                        } else {
                            // console.log(data2);
                        }
                    }
